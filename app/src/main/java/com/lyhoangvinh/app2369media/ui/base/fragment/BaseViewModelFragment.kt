...
import com.lyhoangvinh.app2369media.ui.base.activity.BaseActivity
import com.lyhoangvinh.app2369media.ui.base.fragment.BaseFragment
import com.lyhoangvinh.app2369media.ui.base.viewmodel.BaseViewModel
...
abstract class BaseViewModelFragment<B : ViewDataBinding, VM : BaseViewModel> : BaseFragment<B>() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        check(activity is BaseActivity) { "All fragment's container must extend BaseActivity" }
    }
